...
# %pip install numpy multirex matplotlib pandas joblib
...
# --- SOLUTION ---
# Use a tf.device block to ensure the initial tensors are created on the CPU
# This prevents the massive copy operation that causes the GPU OOM error.
